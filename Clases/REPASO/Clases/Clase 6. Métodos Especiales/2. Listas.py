...
"""
método index ()
El método index () devuelve 
el primario Apariencia de el valor requerido.
"""
...
función len ()
La función len () 
devuelve el número de elementos en una lista especificada.
"""
...
El método insert () inserta 
lo requerido valor en la posición deseada.
"""
...
función count ()
El método count ()
 devuelve el número de elementos con el deseado valor.
"""
...
"""
función pop ()
El método pop () elimina el 
elemento en la posición requerida.
"""
...
función remove ()
El método remove () 
elimina el primero ocurrencia 
del elemento con el especificado valor.
"""
...
"""
función copiar ()
El método copy () devuelve
 una copia de la lista especificada 
 y crea la nueva lista.
"""
