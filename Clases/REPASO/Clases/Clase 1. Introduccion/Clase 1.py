...
mensaje+="Verónica"
print(mensaje)
#Concatenación.- Es una operación que consiste en unir dos cadenas o más, 
...
#Búsqueda.- Consiste en localizar dentro de una cadena, 
# una subcadena más pequeña a un carácter. 
# Para lo cual es necesario utilizar el método find.
print("Búsqueda")
mensaje="Hola Verónica"
buscar_subcadena=mensaje.find("Verónica")
print(buscar_subcadena)
#La extracción.- se trata de sacar fuera e una cadena, 
...
para uso exclusivo del lenguaje de programaci[on, 
que no pueden ser utilizadas para identificar y nombrar 
variables, metodos, objetos o cualquier elemento 
...
tanto numéricos enteros, asi como decimales también conocidos como reales
suma (+)
rest (-)
multipliciones(*)
divisiones(/)
...
Es una instrucción o grupo de instrucciones,
 que se ejecuta cuando a un programa se le establece una condición lógica.
Al cumplirse dicha condición, 
el programa ejecuta la instrucción que ha sido asignada a esta condición
